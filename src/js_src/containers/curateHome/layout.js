      ...
      <div className='row'>
        <div className={SMALL_COL_CLASS}>
          <ul className='vertical menu'>
            ...
            <li><span><Link className={(location === '/new_allele') ? style.activeLink : null} to='/new_allele'><i className='fa fa-sticky-note' />Allele NEW</Link> | <Link className={(location === '/search_allele') ? style.activeLink : null} to='/search_allele'>UPDATE</Link></span></li>	    
