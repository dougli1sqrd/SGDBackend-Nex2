      ...
      <form onSubmit={this.handleSubmit} ref='form'>
        ...
        <div className='row'>
          ...
          <div className='columns medium-6 end'>
            <a href='https://docs.google.com/spreadsheets/d/1HLYXJARlbQT_GtcN6PdfT5m53jLp9FgdT3nxjjiKtWs/edit?usp=sharing' rel="noopener noreferrer" target='_blank' >Funccompannotation template file </a>
          </div>
        </div>
