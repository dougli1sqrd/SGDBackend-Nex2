...
def main(global_config, **settings):
    ...
    config.add_route('funccomp_insert_update','/funccomp', request_method='POST')
    config.add_route('funccomp_by_filters','/get_funccomp',request_method='POST')
    config.add_route('funccomp_delete','/funccomp/{id}/{dbentity_id}', request_method='DELETE')
    config.add_route('funccomp_file', '/funccomp_file', request_method='POST')
