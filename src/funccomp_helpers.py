...
def insert_update_funccomp_annotations(request):
    try:
...
def get_funccomp_by_filters(request):
    try:
...
def delete_funccomp_annotation(request):
    try:
...
def upload_funccomp_file(request):
