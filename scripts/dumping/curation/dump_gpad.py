...
def dump_data():
    ...
    for x in nex_session.query(Goextension).all():
        if x.annotation_id in annotation_id_to_extensions:
            annotation_id_to_extensions[x.annotation_id] = annotation_id_to_extensions[x.annotation_id] + "|" + x.dbxref_id
        else:
            annotation_id_to_extensions[x.annotation_id] = x.dbxref_id
    ...
    for x in nex_session.query(Goannotation).all():
        ...
        # col6: With_or_From
        col6 = annotation_id_to_supportingevidencs.get(x.annotation_id, '')

        # col7: TAXON ID
        col7 = TAXON

        # col8: date generated
        col8 = str(x.date_created).split(' ')[0]

        # col9: source
        col9 = id_to_source.get(x.source_id, '')

        # col10: go extensions
        col10 = annotation_id_to_extensions.get(x.annotation_id, '')

        # col11: annotation properties
        col11 = "contributor-id=" + curator_to_orcid_mapping.get(x.created_by, 'x.created_by') + '|id=' + str(x.annotation_id)
...
def get_curator_to_orcid_mapping():
    ...
    return { 'FISK'       : '0000-0003-4929-9472',
             'JULIEP'     : 'Julie Park',
             'STACIA'     : '0000-0001-5472-917X', 
             'PLLOYD'     : '0000-0003-3508-5553',
             'RAMA'       : '0000-0003-2468-9933',
             'DWIGHT'     : '0000-0002-8546-7798',
             'MAREK'      : '0000-0001-6749-615X',
             'JDEMETER'   : '0000-0002-7301-8055',
             'MIDORI'     : '0000-0003-4148-4606',
             'EDITH'      : '0000-0001-9799-5523',
             'PCNG'       : '0000-0001-8208-652X',
             'CINDY'      : 'Cynthia Krieger',
             'KARA'       : '0000-0002-7010-0264',
             'DIANE'      : '0000-0003-3166-4638',
             'JOANNA'     : '0000-0003-2678-2824',
             'JODI'       : 'Jodi Hirschman',
             'SUZIA'      : '0000-0001-6787-2901',
             'KCHRIS'     : '0000-0001-5501-853X',
             'NASH'       : '0000-0002-3726-7441',
             'KMACPHER'   : '0000-0002-2657-8762',
             'MICHEAL'    : '0000-0003-3841-4324',
             'MARIA'      : 'Maria Costanzo',
             'ROSE'       : '0000-0002-6475-3373',
             'EURIE'      : '0000-0002-1775-4998',
             'TLJ'        : '0000-0003-2387-6411',
             'CHANDRA'    : '0000-0002-8379-6600',
             'ANAND'      : 'Anand Sethuraman',
             'OTTO'       : 'OTTO'
    }
