...
def dump_data():
    ...
    generate_not_feature_seq_file(nex_session, taxonomy_id, dbentity_id_to_data, so_id_to_display_name)
    
    dbentity_id_to_defline = generate_dna_seq_file(nex_session, taxonomy_id, dbentity_id_to_data,
                                                   contig_id_to_chr, so_id_to_display_name,
                                                   codingFile, 'CODING')
    
    generate_dna_seq_file(nex_session, taxonomy_id, dbentity_id_to_data, contig_id_to_chr,
                          so_id_to_display_name, genomicFile, 'GENOMIC')

    generate_dna_seq_file(nex_session, taxonomy_id, dbentity_id_to_data, contig_id_to_chr,
                          so_id_to_display_name, oneKBFile, '1KB')

    generate_protein_seq_file(nex_session, taxonomy_id, dbentity_id_to_defline, proteinFile)

    nex_session.close()
    
def generate_protein_seq_file(nex_session, taxonomy_id, dbentity_id_to_defline, seqFile):
...
def generate_not_feature_seq_file(nex_session, taxonomy_id, dbentity_id_to_data, so_id_to_display_name):

    fw = open(notFeatFile, "w")
...
def generate_dna_seq_file(nex_session, taxonomy_id, dbentity_id_to_data, contig_id_to_chr, so_id_to_display_name, seqFile, dna_type):
